...
- **Save Durability Stack (v3.5.3+)**: atomic-rename save (#36), actor-based concurrency safety (#39), `keep_bak` opt-in rollback (#38), and `autosave_every` per-mutation checkpointing with explicit `recover_from_autosave` (#37)
